...
# Leer las proyecciones del frame_0000.jpg desde projection_bboxes.txt
projections = []
...
with open('projection_bboxes.txt', 'a') as f:
    for frame in frames:
...
print("📄 Archivo projection_bboxes.txt actualizado")
