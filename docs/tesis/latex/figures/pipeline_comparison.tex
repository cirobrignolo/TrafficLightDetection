...
% Para usar en el capitulo 4 de la tesis
...
\end{tikzpicture}
\caption{Pipeline de la reimplementacion (simplificado)}
\label{fig:pipeline_reimpl}
\end{figure}
...
\node[font=\bfseries, right=5cm of titleA] (titleR) {Reimplementacion};
...
\end{tikzpicture}
\caption{Comparacion lado a lado: Apollo vs Reimplementacion}
