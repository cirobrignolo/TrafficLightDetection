...
print("🎨 APLICANDO FILTRO PARCIAL (desde frame_0355 en adelante)")
print(f"📂 Input: {input_dir}")
print(f"📁 Output: {output_dir}")
print(f"🌅 Filtro aplicado desde frame_{FILTER_START_FRAME:04d} en adelante")
...
print(f"   📋 Frames copiados (sin filtro): {copied_count}")
